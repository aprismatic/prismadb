...
This Docker Compose file will start a PostgreSQL server with Prisma/DB UDFs, as well as the Prisma/DB Proxy (trial version) for PostgreSQL. Importing/exporting of encryption keys is disabled in the trial build of Prisma/DB Proxy, but other than that, it is a fully featured build.
